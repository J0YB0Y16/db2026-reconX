...
public final class BondTrade implements TradeType {
    ...
    @Override public String toString() {
        return "BondTrade[ref=" + tradeRef + ", isin=" + isin + ", face=" + faceValue + " " + currency + ", coupon=" + couponRate + ", maturity=" + maturityDate + ", side=" + side + "]";
    }
    ...
    public static final class Builder {
        ...
        public BondTrade build() {
            ...
            if (maturityDate.isBefore(tradeDate)) throw new IllegalStateException("maturityDate cannot be before tradeDate");
